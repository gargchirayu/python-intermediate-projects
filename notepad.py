...
class Notepad:
    ...
    def __init__(self, **kwargs):
        ...
        # help menu
        # self.__thisHelpMenu.add_command(label="Help", command=self.__help)
        self.__thisHelpMenu.add_separator()
        self.__thisHelpMenu.add_command(label="About Notepad", command=self.__about)
        self.__thisMenuBar.add_cascade(label="Help", menu=self.__thisHelpMenu)

        self.__root.config(menu=self.__thisMenuBar)
        # setting the scroll bar to auto adjust its fill
    ...
    def __about(self):
        showinfo("Notepad", "Developed by Chirayu Garg")
...
notepad = Notepad(width=960, height=720)
notepad.run()
